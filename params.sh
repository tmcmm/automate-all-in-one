...
WINDOWS_VM_OS_DISK_NAME="$WINDOWS_VM_NAME""_disk_01"
...
LINUX_DNS_VNET_CIDR="$LINUX_VNET_2_OCTETS.6.0/24"
LINUX_DNS_SNET_CIDR="$LINUX_VNET_2_OCTETS.6.0/28"
...
LINUX_VM_DNS_PRIV_IP="$LINUX_VNET_2_OCTETS.6.4"
